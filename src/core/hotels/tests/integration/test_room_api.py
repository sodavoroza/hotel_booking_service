...
class TestRoomAPI(APIBaseTest):
    def test_create_room(self, hotel) -> None:
    ...
    def test_list_rooms(self, hotel) -> None:
    ...
    def test_sort_rooms_by_price(self, hotel) -> None:
        Room.objects.create(
    ...
    def test_delete_room(self, room) -> None:
